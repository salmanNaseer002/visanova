...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-[#25D366] text-white rounded-full shadow-2xl transition-all duration-500 group hover:scale-105 ${
